  ...
  return (
    <>
      ...
      <div className="nx-social-row">
        <button type="button" className="nx-social-btn" onClick={() => showToast("Google sign-in is coming soon", "info")}>
          ...
          <span style={{ marginInlineStart: 8 }}>Google</span>
        </button>
        <button type="button" className="nx-social-btn" onClick={() => showToast("Facebook sign-in is coming soon", "info")}>
          ...
          <span style={{ marginInlineStart: 8 }}>Facebook</span>
        </button>
      </div>
    </>
  );
